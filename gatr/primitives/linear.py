...
def _compute_pin_equi_linear_basis(
    ...
    basis_elements = [
        [0],                    # Scalar component
        [1, 2, 3, 4],          # Vector components
        [5, 6, 7, 8, 9, 10],   # Bivector components
        [11, 12, 13, 14],      # Trivector components
        [15],                   # Pseudoscalar component
        [(1, 0)],              # Vector to scalar mapping
        [(5, 2), (6, 3), (7, 4)],  # Bivector to vector mapping
        [(11, 8), (12, 9), (13, 10)],  # Trivector to bivector mapping
        [(15, 14)]             # Pseudoscalar to trivector mapping
    ]
    basis = []
